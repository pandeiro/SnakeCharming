...
```python
t_flight = 2 * vy / g  # Total time until ball returns to ground
t = np.linspace(0, t_flight, 100)  # Create 100 equally-spaced time points
```

**Understanding the physics:** 
- Time to peak: vy / g
- Total flight time: 2 * (vy / g) for symmetric trajectory
- `linspace` creates an array of time values from 0 to t_flight
